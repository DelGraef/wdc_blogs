module.exports = {
    ...
    themeConfig: {
        ...
        nav: [
            ...
            {
                text: '个人网站',
                link: 'http://101.42.4.196:90/#/'
            },
            {
                text: '友情链接',
                items: [
                    { text: 'gitee', link: 'https://gitee.com/xiaowan1997' },
                    { text: 'bilibili', link: 'https://space.bilibili.com/43627425/' }
            ...
            '/blogs/': [
                {
                    ...
                    items: [
                        {text: '概述', link: '/blogs/'},
                        {text: '开发常用网站', link: '/blogs/more'},
                        {text: '重写Alert', link: '/blogs/reWriteAlert'},
                        {text: '切换多语言', link: '/blogs/changeLanguage'},
                        {text: '微信扫码登录', link: '/blogs/wechatLogin'},
                    ]
                }
            ],
        },
        ...
        editLink: {
            text: '我的博客',
            pattern: 'https://gitee.com/xiaowan1997/wdc_blog'
        },

        // 页面底部
        footer: {
            message: '',
            copyright: 'Copyright © 2023 WDC'
        }
    }
}